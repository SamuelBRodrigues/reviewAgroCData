...
#' }
get_valor_p_hectare_lp <- function(cod_ibge = "Brasil"){

  if(cod_ibge == "Brasil"){
    api_req <- "/t/6956/n6/all/v/10076,10079/p/all/c829/46302/c227/113864/c220/110085/d/v10076%200,v10079%200"
    ...
    api_req <- stringr::str_glue("/t/6956/n6/{vetor_municipios_alvo}/v/10076,10079/p/all/c829/46302/c227/113864/c220/110085/d/v10076%200,v10079%200")
  }else{
