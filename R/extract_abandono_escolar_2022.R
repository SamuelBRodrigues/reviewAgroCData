#' Extract School Dropout Rates for 2022
#'
...
#' df <- extract_abandono_escolar_2022()
#'
#' # Specifying a different file path
#' df <- extract_abandono_escolar_2022("path/to/your/file.xlsx")
#'
#' @export
extract_abandono_escolar_2022 <- function(
  ...
  abandono_escolar_2022 <- inep_data %>%
  ...
  abandono_escolar_2022 <- abandono_escolar_2022 %>%
